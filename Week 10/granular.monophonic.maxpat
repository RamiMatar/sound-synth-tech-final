...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 180.0, 237.083333333333314, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 180.0, 270.5, 48.0, 22.0 ],
					"text" : "loop $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 609.5, 201.5, 85.0, 20.0 ],
					"text" : "<waveform~>"
				}
...
,
					"patching_rect" : [ 184.0, 104.0, 21.0, 79.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 640.5, 56.0, 61.0, 20.0 ],
					"style" : "helpfile_label",
					"text" : "select all"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 536.75, 56.0, 94.0, 20.0 ],
					"style" : "helpfile_label",
					"text" : "select end ms"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 419.0, 56.0, 94.0, 20.0 ],
					"style" : "helpfile_label",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 292.75, 56.0, 111.0, 20.0 ],
					"style" : "helpfile_label",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 180.0, 56.0, 101.0, 20.0 ],
					"style" : "helpfile_label",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 642.5, 76.0, 57.0, 23.0 ],
					"text" : "0 -1 0 -1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 498.5, 201.0, 40.0, 21.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 402.5, 201.0, 40.0, 21.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 306.5, 201.0, 40.0, 21.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 210.5, 201.0, 40.0, 21.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 557.75, 76.0, 52.0, 23.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 440.0, 76.0, 52.0, 23.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 322.25, 76.0, 52.0, 23.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 204.5, 76.0, 52.0, 23.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 31.0, 254.5, 44.0, 23.0 ],
					"text" : "sig~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 323.333344000000011, 212.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 204.5, 105.0, 490.0, 93.0 ],
					"setmode" : 3,
					"ticks" : 8,
					"vlabels" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 113.666670262813568, 601.0, 68.0, 22.0 ],
					"text" : "send~ out2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 31.0, 601.0, 68.0, 22.0 ],
					"text" : "send~ out1"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 652.0, 102.0, 685.0, 102.0 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 496.600000000000023, 272.666687000000024, 232.5, 272.666687000000024 ],
					"order" : 1,
					"source" : [ "obj-68", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 402.399999999999977, 264.666687000000024, 136.0, 264.666687000000024 ],
					"order" : 2,
					"source" : [ "obj-68", 2 ]
				}
